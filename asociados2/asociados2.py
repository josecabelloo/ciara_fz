...
class grupo_familiar(osv.osv):
    ...
    _columns = {
        ...
        'movimiento_ids': fields.one2many('movimiento_grupo', 'grupo_familiar_id', 'Persona', required=True),
...
class enf_dis_grupo(osv.osv):
    ...
    _columns = {
        'nombre': fields.char('Nombre Enfermedad', size=150, required=True),
        'grupo_familiar_id': fields.many2one('grupo_familiar', 'Persona'),
        'observacion': fields.text('Observacion'),
        'enfer_disc':fields.selection([('enf', 'Enfermedad'), ('dis', 'Discapacidad')], 'Tipo', help="Selecciona una enfermedad o discapacidad", required=False, states={'productiva': [('readonly', False)]}),
    }
    _defaults = {
       'enfer_disc': 'enf',
